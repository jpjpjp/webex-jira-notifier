...
testCases.push(new TestCase('./jira-event-test-cases/1522969922819-jira:issue_updated-issue_resolved.json',
  ...
  ['',
    '{"markdown":"<br>Hancheng Hsiung updated a Jira Bug: **Failed the api call to addservice for short code number due to new logic for \\"pricingPrefix\\"** that you are watching."}\n'+
    '{"markdown":"> updated field:resolution to:\\"Fixed\\", and updated field:status from:\\"In Development\\" to:\\"Fixed\\""}\n'+
...
testCases.push(new TestCase('./jira-event-test-cases/1522969913206-jira:issue_updated-issue_work_started.json',
  ...
  ['{"markdown":"<br>Hancheng Hsiung assigned existing Jira Bug: **Failed the api call to addservice for short code number due to new logic for \\"pricingPrefix\\"** to you."}\n'+
    '{"markdown":"> Description:Hi Mike and Wing,<br /> I was running some regression tests today on QA CCS2 system (15.12.04 \\"buildDate\\": \\"2018-02-22 16:27:36\\") and the following 3 tests failed when calling BW’s “addservice” api.<br />Possible config error or bug relating to “pricingPrefix” value?<br />My understanding from Sanjiv is that for Shortcodes, BW will still look up the plan using numeric instead of xx:x:x format, or did I misunderstand? Thx. -Joanne<br /> <br />+Tests and log snippets:+<br />Test 1 – Short Code Normal<br />Mar 29 03:48:22.168 INFO  localhost PRISM 9410///017dd982-fbc8-4bdc-ba9c-b131fca22f3c/1/[] [http-0.0.0.0-8080-exec-16] Billwise response: \\\\{\\"success\\":false,\\"requestId\\":203372602,\\"message\\":\\"Failure\\",\\"datasetId\\":\\"290\\",\\"companyCd\\":\\"290\\",\\"customerCd\\":\\"011301\\",\\"packageCd\\":\\"SC01\\",\\"servicePoolCd\\":\\"000\\",\\"salesAgentCd\\":\\"000001\\",\\"effectiveDate\\":\\"2018-03-29T03:48:22Z\\",\\"reasonCd\\":\\"A\\",\\"updateSwitch\\":true,\\"switchCd\\":\\"290\\",\\"serviceId\\":\\"N000000000007660\\",\\"alternateServiceId\\":\\"19513000004\\",\\"pricingPrefix\\":\\"US:G:B\\",\\"rateElementType\\":30,\\"errors\\":[{\\"field\\":\\"pricingPrefix\\",\\"value\\":\\"US:G:B\\",\\"errorCode\\":\\"apiAddServiceCommand.pricingPrefix.missingRecurringAmount.error\\"}]}<br /> <br />Test2 – Short Code Shared<br />Mar 29 03:48:22.660 INFO  localhost PRISM 9410///8bb0a79a-d4b1-4c91-bb97-72aca241c453/1/[] [http-0.0.0.0-8080-exec-23] Billwise response: \\\\{\\"success\\":false,\\"requestId\\":203372603,\\"message\\":\\"Failure\\",\\"datasetId\\":\\"290\\",\\"companyCd\\":\\"290\\",\\"customerCd\\":\\"011301\\",\\"packageCd\\":\\"SS01\\",\\"servicePoolCd\\":\\"000\\",\\"salesAgentCd\\":\\"000001\\",\\"effectiveDate\\":\\"2018-03-29T03:48:22Z\\",\\"reasonCd\\":\\"A\\",\\"updateSwitch\\":true,\\"switchCd\\":\\"290\\",\\"serviceId\\":\\"N000000000007661\\",\\"alternateServiceId\\":\\"19515000004\\",\\"pricingPrefix\\":\\"US:G:S\\",\\"rateElementType\\":37,\\"errors\\":[{\\"field\\":\\"pricingPrefix\\",\\"value\\":\\"US:G:S\\",\\"errorCode\\":\\"apiAddServiceCommand.pricingPrefix.missingRecurringAmount.error\\"}]}<br /> <br />Test3 – this is a customer owned number<br />Mar 29 03:48:24.067 INFO  localhost PRISM 9410///d5832114-1e28-4be4-8053-b3e80c3f1ed2/1/[] [http-0.0.0.0-8080-exec-30] Billwise response: {\\"success\\":false,\\"requestId\\":203372609,\\"message\\":\\"Failure\\",\\"datasetId\\":\\"290\\",\\"companyCd\\":\\"290\\",\\"customerCd\\":\\"011301\\",\\"packageCd\\":\\"TP1A\\",\\"servicePoolCd\\":\\"000\\",\\"salesAgentCd\\":\\"000001\\",\\"effectiveDate\\":\\"2018-03-29T03:48:23Z\\",\\"reasonCd\\":\\"A\\",\\"updateSwitch\\":true,\\"switchCd\\":\\"290\\",\\"serviceId\\":\\"N000000000007663\\",\\"alternateServiceId\\":\\"19517000097\\",\\"pricingPrefix\\":\\"null:G:B\\",\\"rateElementType\\":10,\\"errors\\":[{\\"field\\":\\"pricingPrefix\\",\\"value*\\":\\"null:G:B\\",\\"*errorCode\\":\\"apiAddServiceCommand.pricingPrefix.missingRecurringAmount.error\\"}]}<br /> <br /> "}\n'+
    'https://jira-eng-gpk2.cisco.com/jira/browse/TROPO-13320',
  '{"markdown":"<br>Hancheng Hsiung updated a Jira Bug: **Failed the api call to addservice for short code number due to new logic for \\"pricingPrefix\\"** that you are watching."}\n'+
    '{"markdown":"> updated field:assignee from:\\"Wing Tang\\" to:\\"Hancheng Hsiung\\", and updated field:status from:\\"Open\\" to:\\"Hancheng Hsiung\\""}\n'+
    'https://jira-eng-gpk2.cisco.com/jira/browse/TROPO-13320'], 2));
...
testCases.push(new TestCase('./jira-event-test-cases/1522952583499-jira:issue_updated-issue_commented.json',
  ...
  ['', '',   // There are two mentioned people not using the bot
    ...
    '{"markdown":"> Testing behavior when a new notification WITH mentions is added to a ticket with watchers.<br /> <br />[~jalumbau], [~shraban], [~hadougla] note that I\'m testing this in my own dev environment at the moment.  You won\'t see updates from the bot until I push it to deployment.   Will post when that happens."}\n'+
...
testCases.push(new TestCase('./jira-event-test-cases/issue_update-issue_assigned_to_jp.json',
  ...
  ['{"markdown":"<br>JP Shipherd assigned existing Jira Task: **Test Task -- please ignore -- to be deleted** to you."}\n'+
    ...
    '   Let me know or at mention me in a comment.<br /> <br />I will add you and [~shraban] as watchers to this ticket in an effort to understand how Jira exposes watchers in its webhooks"}\n'+
    'https://jira-eng-gpk2.cisco.com/jira/browse/SPARK-7329',
  '{"markdown":"<br>JP Shipherd updated a Jira Task: **Test Task -- please ignore -- to be deleted** that you are watching."}\n'+
    '{"markdown":"> updated field:assignee to:\\"JP Shipherd\\""}\n'+
    'https://jira-eng-gpk2.cisco.com/jira/browse/SPARK-7329'], 2));
...
testCases.push(new TestCase('./jira-event-test-cases/1522768650390-jira:issue_updated-issue_generic.json',
  ...
  // Watcher updates:
    '{"markdown":"<br>JP Shipherd updated a Jira Task: **Test Task -- please ignore -- to be deleted** that you are watching."}\n' +
  '{"markdown":"> updated field:status from:\\"New\\" to:\\"In Progress\\""}\n'+
  'https://jira-eng-gpk2.cisco.com/jira/browse/SPARK-7329',
    '{"markdown":"<br>JP Shipherd updated a Jira Task: **Test Task -- please ignore -- to be deleted** that you are watching."}\n' +
  '{"markdown":"> updated field:status from:\\"New\\" to:\\"In Progress\\""}\n'+
  'https://jira-eng-gpk2.cisco.com/jira/browse/SPARK-7329'], 3));
...
testCases.push(new TestCase('./jira-event-test-cases/1523584338774-jira:issue_created-issue_created.json',
  ...
  ['{"markdown":"<br>JP Shipherd created a Jira Task: **Testing 3** and assigned it to you."}\n'+
  '{"markdown":"> Description:Testing 3"}\n'+
  'https://jira-eng-gpk2.cisco.com/jira/browse/OPS-9914'], 1));
